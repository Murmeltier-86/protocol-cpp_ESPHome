...
CONF_XML_STATS_REPRIME_TR37_BEFORE_CYCLE = "xml_stats_reprime_tr37_before_cycle"
CONF_XML_STATS_HANDSHAKE_BEFORE_CYCLE = "xml_stats_handshake_before_cycle"
    ...
    cv.Schema(
        {
            ...
            cv.Optional(CONF_XML_STATS_REPRIME_TR37_BEFORE_CYCLE, default=False): cv.boolean,
            cv.Optional(CONF_XML_STATS_HANDSHAKE_BEFORE_CYCLE, default=True): cv.boolean,
...
async def to_code(config):
    ...
    cg.add(var.set_xml_stats_reprime_tr37_before_cycle(config[CONF_XML_STATS_REPRIME_TR37_BEFORE_CYCLE]))
    cg.add(var.set_xml_stats_handshake_before_cycle(config[CONF_XML_STATS_HANDSHAKE_BEFORE_CYCLE]))
