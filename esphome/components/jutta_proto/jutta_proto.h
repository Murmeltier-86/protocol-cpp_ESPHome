...
class JuraComponent : public esphome::Component, public esphome::uart::UARTDevice {
 ...
 protected:
  ...
  bool handle_decoded_machine_line_(const std::string &line, const char *source);
  ...
  void finish_bluefrog_original_core_round_(uint32_t now, bool timeout, const char *missing_step = nullptr);
  ...
  uint32_t bluefrog_26_ascii_decoded_count_{0};
  uint32_t bluefrog_26_tf_seen_count_{0};
  uint32_t bluefrog_26_tv_seen_count_{0};
  uint32_t bluefrog_26_binary_candidate_count_{0};
  std::string last_26_frame_hex_{};
  std::string last_bluefrog_26_decoded_line_{};
  std::string last_bluefrog_26_cachewriter_source_{};
  ...
  bool bluefrog_original_core_round_attempted_{false};
  ...
  uint32_t bluefrog_original_core_round_rx26_baseline_{0};
  uint32_t bluefrog_original_core_round_tf_baseline_{0};
  uint32_t bluefrog_original_core_round_tv_baseline_{0};
  bool bluefrog_original_core_round_stats_delay_logged_{false};
  ...
  bool post_t3_runtime_observe_active_{false};
  uint32_t post_t3_runtime_observe_start_ms_{0};
  uint16_t post_t3_runtime_observe_rx_26_count_{0};
  uint16_t post_t3_runtime_observe_tf_seen_{0};
